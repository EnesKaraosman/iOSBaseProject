...
/**
 Protocol that allows an element to be indentified.
 By default, it uses it's class name as the indentifier.
 This is particularly useful for UITableViewCell and UICollectionViewCell instances,
 where a reuseIdentifier is needed.
